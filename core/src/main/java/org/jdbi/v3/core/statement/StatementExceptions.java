...
public class StatementExceptions implements JdbiConfig<StatementExceptions> {
    ...
    public enum MessageRendering implements Function<StatementException, String> {
        ...
        NONE {
            @Override
            public String apply0(StatementException exc, StatementContext ctx) {
        ...
        public String apply(StatementException exc) {
            ...
            if (ctx == null) {
                return NONE.apply0(exc, ctx);
            }
            return apply0(exc, ctx);
        }

        protected abstract String apply0(StatementException exc, StatementContext ctx);
    }
